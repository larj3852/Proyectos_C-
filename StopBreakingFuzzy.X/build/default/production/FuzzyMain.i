...
void lcd_write_s(const unsigned char *);
...
void lcd_ini(void){
    ...
    lcd_cmd(0B00110000);
    _delay((unsigned long)((5)*(8000000/4000)));
    lcd_cmd(0B00110000);
    _delay((unsigned long)((1)*(8000000/4000)));
    lcd_cmd(0B00110000);
...
void lcd_write_s(const unsigned char *st){
...
void lcd_pos(int fila, int columna){
...
void main(void) {
    ...
    while(1){
        ...
        d2=cmf;
        cm=cm-6;
        V=round((d1-d2)/((tiempo/200000)+0.05));
        V=abs(V);
...
void setup(void){
    ...
    _delay((unsigned long)((1000)*(8000000/4000)));
}
